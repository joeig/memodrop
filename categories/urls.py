...
urlpatterns = [
    ...
    url(r'^braindump/(?P<category_pk>[0-9]+)/$', braindump_session, name='braindump-session'),
    url(r'^braindump/(?P<category_pk>[0-9]+)/card/(?P<card_pk>[0-9]+)/ok$', braindump_ok, name='braindump-ok'),
    url(r'^braindump/(?P<category_pk>[0-9]+)/card/(?P<card_pk>[0-9]+)/nok$', braindump_nok, name='braindump-nok'),
]
